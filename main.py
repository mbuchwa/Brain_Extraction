...
if __name__ == '__main__':
    ...
    parser.add_argument("--data-dir", '-dd', default='/home/marcus/Desktop/Datasets/ADNI2/ADNI2-GO/',
    ...
    for dirpath, dirnames, filenames in os.walk(data_dir):
        ...
        if not dirnames:
            print(f'\n ################## processing patient image: {dirpath} ################## \n')
            image_names = [x for x in os.listdir(dirpath) if x.endswith('.nii')]
            for image_name in image_names:
                image_path = f'{dirpath}/{image_name}'
                bet_image_path = f'{image_path}_bet.nii.gz'
                bet_resampled_image_path = f'{image_path}_bet_resampled.nii.gz'
                ...
                ants.image_write(bfc_image_resampled, bet_resampled_image_path)
                ...
                mytx = ants.registration(fixed=mi, moving=bfc_image_resampled, type_of_transform='Rigid')
